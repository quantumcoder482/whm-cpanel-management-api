    ...
    <div class="container">
      <div class="col-md-12">
        <form class="form-horizontal" id="form_main" action="<?php echo $_SERVER[' PHP_SELF']; ?>" method="POST">
          ...
          <div class="form-group">
            <label class="control-label col-md-2" for="confirm_pwd">Password Confirm:</label>
            <div class="col-md-10">
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <div class="checkbox">
                <label><input id="chk_confirm" type="checkbox"> I remember all informations </label>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="col-md-12">
        <form class="form-horizontal">
          ...
          <div class="form-group">
            <label class="control-label col-md-2">cPanel Address:</label>
            <div class="col-md-10">
              <span style="font-weight:700;font-size:16px;position:absolute;padding-right:15px; padding-left:15px;padding-top:7px">
                <a href="<?php echo "https://" . $serveraddr; ?>" target="_blank"><?php echo "https://" . $serveraddr; ?></a>
              </span>
            </div>
          </div>
        </form>
...
<script>
  $(document).ready(function() {
    $('#btn_submit').click(function(e) {
      e.preventDefault();
      console.log('text');
      if ($('#chk_confirm').prop("checked") == true) {
        $('#form_main').submit();
      } else {
        alert('Please confirm and check remember');
      }
    });
  });
</script>
